...
public class LightBlueSlimeBlock extends SlimeBlock implements ModBlockColor, ModItemColor {
    private static final double BOUNCE_MULTIPLIER = 1.0D;

    public LightBlueSlimeBlock(Properties properties) {
        super(properties);
    }
    ...
    public int getColor(int tintIndex) {
        return tintIndex == 0 ? DyeColor.LIGHT_BLUE.getMaterialColor().col : -1;
    }
}
