...
public class YellowSlimeBlock extends SlimeBlock implements ModBlockColor, ModItemColor {
    private static final double BOUNCE_MULTIPLIER = 1.0D;

    public YellowSlimeBlock(Properties properties) {
        super(properties);
    }
    ...
    public int getColor(int tintIndex) {
        return tintIndex == 0 ? DyeColor.YELLOW.getMaterialColor().col : -1;
    }
}
