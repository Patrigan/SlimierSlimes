...
import mod.patrigan.slimier_slimes.entities.CrystalSlimeEntity;
...
public class CrystalSlimeRenderer extends MobRenderer<CrystalSlimeEntity, SlimeModel<CrystalSlimeEntity>> {

    protected static final ResourceLocation TEXTURE = new ResourceLocation(SlimierSlimes.MOD_ID, "textures/entity/crystal_slime.png");

    public CrystalSlimeRenderer(EntityRendererProvider.Context context) {
        super(context, new SlimeModel<>(context.bakeLayer(ModelLayers.SLIME)), 0.7f);
        this.addLayer(new SlimeOuterLayer<>(this, context.getModelSet()));
    }

    @Override
    public void render(CrystalSlimeEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
