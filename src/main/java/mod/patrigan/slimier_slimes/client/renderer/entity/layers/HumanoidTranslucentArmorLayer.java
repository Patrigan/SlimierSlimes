package mod.patrigan.slimier_slimes.client.renderer.entity.layers;

import com.google.common.collect.Maps;
import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import mod.patrigan.slimier_slimes.client.renderer.ModRenderType;
...
@OnlyIn(Dist.CLIENT)
public class HumanoidTranslucentArmorLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> extends RenderLayer<T, M> {
   private static final Map<String, ResourceLocation> ARMOR_LOCATION_CACHE = Maps.newHashMap();
   private final A innerModel;
   private final A outerModel;

   public HumanoidTranslucentArmorLayer(RenderLayerParent<T, M> p_i50936_1_, A p_i50936_2_, A p_i50936_3_) {
      super(p_i50936_1_);
   ...
   public void render(PoseStack p_225628_1_, MultiBufferSource p_225628_2_, int p_225628_3_, T entity, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      this.renderArmorPiece(p_225628_1_, p_225628_2_, entity, EquipmentSlot.CHEST, p_225628_3_, this.getArmorModel(EquipmentSlot.CHEST));
      this.renderArmorPiece(p_225628_1_, p_225628_2_, entity, EquipmentSlot.LEGS, p_225628_3_, this.getArmorModel(EquipmentSlot.LEGS));
      this.renderArmorPiece(p_225628_1_, p_225628_2_, entity, EquipmentSlot.FEET, p_225628_3_, this.getArmorModel(EquipmentSlot.FEET));
      this.renderArmorPiece(p_225628_1_, p_225628_2_, entity, EquipmentSlot.HEAD, p_225628_3_, this.getArmorModel(EquipmentSlot.HEAD));
   }

   private void renderArmorPiece(PoseStack p_241739_1_, MultiBufferSource p_241739_2_, T p_241739_3_, EquipmentSlot p_241739_4_, int p_241739_5_, A p_241739_6_) {
      ...
      if (itemstack.getItem() instanceof ArmorItem && isSlime(itemstack.getItem())) {
         ...
         if (armoritem.getSlot() == p_241739_4_) {
            ...
            }else if (armoritem instanceof net.minecraft.world.item.DyeableLeatherItem) {
   ...
   private void renderColoredModel(PoseStack p_241739_1_, MultiBufferSource p_241739_2_, T p_241739_3_, EquipmentSlot p_241739_4_, int p_241739_5_, A p_241739_6_, ItemStack itemstack, boolean flag1, int i) {
   ...
   private boolean isSlime(Item item) {
      return item.getTags().contains(ARMOR_SLIME_BOOTS.getName()) ||
              item.getTags().contains(ARMOR_SLIME_LEGGINGS.getName()) ||
              item.getTags().contains(ARMOR_SLIME_CHESTPLATE.getName()) ||
              item.getTags().contains(ARMOR_SLIME_HELMET.getName());
   }
   ...
   private void renderModel(PoseStack p_241738_1_, MultiBufferSource p_241738_2_, int p_241738_3_, boolean p_241738_5_, A p_241738_6_, float p_241738_8_, float p_241738_9_, float p_241738_10_, ResourceLocation armorResource) {
      VertexConsumer ivertexbuilder = ItemRenderer.getArmorFoilBuffer(p_241738_2_, ModRenderType.armorCutoutNoCullTranslucent(armorResource), false, p_241738_5_);
