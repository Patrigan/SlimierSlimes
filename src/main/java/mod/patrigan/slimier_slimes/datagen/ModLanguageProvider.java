...
import static mod.patrigan.slimier_slimes.init.ModBlocks.BLOCK_IDS;
import static mod.patrigan.slimier_slimes.init.ModEntityTypes.ENTITY_IDS;
import static mod.patrigan.slimier_slimes.init.ModItems.ITEM_IDS;
...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("itemGroup.slimier_slimes", "Slimier Slimes");
        addConfigOptions();
        addTips();
    }

    private void addTips() {
        add("slimier_slimes.tip.diamond_slime", "Kill the diamond slimes before they hop away!");
    }
