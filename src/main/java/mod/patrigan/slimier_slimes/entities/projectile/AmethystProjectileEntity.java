...
public class AmethystProjectileEntity extends Entity {
    ...
    public AmethystProjectileEntity(EntityType<? extends AmethystProjectileEntity> entityType, Level worldIn) {
        super(entityType, worldIn);
    }

    public AmethystProjectileEntity(Level worldIn, double x, double y, double z, float rotationYaw, int warmupDelayTicks, LivingEntity casterIn) {
        this(ModEntityTypes.AMETYST_PROJECTILE.get(), worldIn);
        this.warmupDelayTicks = warmupDelayTicks;
        this.setCaster(casterIn);
        this.setYRot(rotationYaw * (180F / (float)Math.PI));
        this.setPos(x, y, z);
    }
