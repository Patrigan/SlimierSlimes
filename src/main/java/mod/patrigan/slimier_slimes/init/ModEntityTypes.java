...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<AbstractSlimeEntity>> PINK_SLIME = getSlimeRegistryObject("pink_slime", AbstractSlimeEntity::new, DyeColor.PINK.getMaterialColor().col, false);
    public static final RegistryObject<EntityType<DiamondSlimeEntity>> DIAMOND_SLIME = getSlimeRegistryObject("diamond_slime", DiamondSlimeEntity::new, DyeColor.CYAN.getMaterialColor().col, false);
    public static final RegistryObject<EntityType<AbstractSlimeEntity>> ROCK_SLIME = getSlimeRegistryObject("rock_slime", AbstractSlimeEntity::new, DyeColor.BLUE.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<AbstractSlimeEntity>> CLOUD_SLIME = getSlimeRegistryObject("cloud_slime", AbstractSlimeEntity::new, DyeColor.LIGHT_GRAY.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<CrystalSlimeEntity>> CRYSTAL_SLIME = getSlimeRegistryObject("crystal_slime", CrystalSlimeEntity::new, DyeColor.MAGENTA.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<GlowSlimeEntity>> GLOW_SLIME = getSlimeRegistryObject("glow_slime", GlowSlimeEntity::new, DyeColor.PURPLE.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<GooSlimeEntity>> BROWN_GOO_SLIME = getSlimeRegistryObject("brown_goo_slime", GooSlimeEntity::new, DyeColor.BROWN.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<CreeperSlimeEntity>> CREEPER_SLIME = getSlimeRegistryObject("creeper_slime", CreeperSlimeEntity::new, DyeColor.GREEN.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<SnowSlimeEntity>> SNOW_SLIME = getSlimeRegistryObject("snow_slime", SnowSlimeEntity::new, DyeColor.WHITE.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<CamoSlimeEntity>> CAMO_SLIME = getSlimeRegistryObject("camo_slime", CamoSlimeEntity::new, DyeColor.BROWN.getMaterialColor().col, true);
    public static final RegistryObject<EntityType<LavaSlimeEntity>> LAVA_SLIME = getFireResistantSlimeRegistryObject("lava_slime", LavaSlimeEntity::new, DyeColor.RED.getMaterialColor().col, false);
    public static final RegistryObject<EntityType<AbstractSlimeEntity>> OBSIDIAN_SLIME = getFireResistantSlimeRegistryObject("obsidian_slime", AbstractSlimeEntity::new, DyeColor.BLACK.getMaterialColor().col, false);
    public static final RegistryObject<EntityType<ShroomSlimeEntity>> SHROOM_SLIME = getSlimeRegistryObject("shroom_slime", ShroomSlimeEntity::new, DyeColor.RED.getMaterialColor().col, true);
    //Projectiles
    ...
    private static <T extends AbstractSlimeEntity> RegistryObject<EntityType<T>> getSlimeRegistryObject(String key, final EntityType.EntityFactory<T> sup, int secondaryColor, boolean isSpawnerEntity) {
        ENTITY_IDS.add(key);

        EntityType<T> entityType = EntityType.Builder.of(sup, MobCategory.MONSTER)
    ...
    private static <T extends AbstractSlimeEntity> RegistryObject<EntityType<T>> getFireResistantSlimeRegistryObject(String key, final EntityType.EntityFactory<T> sup, int secondaryColor, boolean isSpawnerEntity) {
        ENTITY_IDS.add(key);
    ...
    private static <T extends Entity> RegistryObject<EntityType<T>> getAmethystProjectileRegistryObject(String key, final EntityType.EntityFactory<T> sup) {
        PROJECTILE_ENTITY_IDS.add(key);
        return ENTITY_TYPES.register(key,
                () -> EntityType.Builder.of(sup, MobCategory.MISC)
                        .sized(0.6f, 0.6f)
    ...
    private static <T extends Entity> Map<DyeColor, RegistryObject<EntityType<T>>> getSlimeballProjectileRegistryObjects(String key, EntityType.EntityFactory<T> sup) {
    ...
    private static <T extends Entity> RegistryObject<EntityType<T>> getSlimeballProjectileRegistryObject(String key, DyeColor dyeColor, final EntityType.EntityFactory<T> sup) {
        String id = dyeColor.getName() + "_" + key;
        PROJECTILE_ENTITY_IDS.add(id);
        return ENTITY_TYPES.register(id,
                () -> EntityType.Builder.of(sup, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10)
