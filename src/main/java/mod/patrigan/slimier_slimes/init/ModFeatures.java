...
import mod.patrigan.slimier_slimes.world.gen.feature.SlimeSpawnerFeature;
...
public class ModFeatures {
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> SLIME_SPAWNER_FEATURE = registerFeature("slime_spawner_feature", () -> new SlimeSpawnerFeature(NoneFeatureConfiguration.CODEC));
