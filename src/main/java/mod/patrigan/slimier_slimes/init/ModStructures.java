...
public class ModStructures {
     ...
     */
    public static final RegistryObject<StructureFeature<NoneFeatureConfiguration>> PILLAGER_SLIME_LAB = registerStructure(PillagerSlimeLab.STRUCTURE_ID, () -> (new PillagerSlimeLab(NoneFeatureConfiguration.CODEC)));
    public static final RegistryObject<StructureFeature<NoneFeatureConfiguration>> SLIME_DUNGEON = registerStructure(SlimeDungeon.STRUCTURE_ID, () -> (new SlimeDungeon(NoneFeatureConfiguration.CODEC)));
    public static final RegistryObject<StructureFeature<NoneFeatureConfiguration>> SEWER = registerStructure(Sewer.STRUCTURE_ID, () -> (new Sewer(NoneFeatureConfiguration.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                ...
                new StructureFeatureConfiguration(18 /* maximum distance apart in chunks between spawn attempts */,
        ...
        setupMapSpacingAndLand(
                ...
                new StructureFeatureConfiguration(6 /* average distance apart in chunks between spawn attempts */,
