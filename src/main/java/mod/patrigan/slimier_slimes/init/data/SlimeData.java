...
import mod.patrigan.slimier_slimes.entities.util.SlimeSizeCalculation;
...
import static mod.patrigan.slimier_slimes.entities.util.SlimeSizeCalculation.*;
...
public class SlimeData {
    ...
    public int getExperienceValue(int size, Random rand) {
        return (int) (int) Math.floor(experienceValue.apply(size, rand));
    }
