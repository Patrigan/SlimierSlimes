...
public class SlimeSpawnData {
    ...
    public MobSpawnSettings.SpawnerData getSpawner(EntityType<? extends Entity> type){
        return new MobSpawnSettings.SpawnerData(type, spawnWeight, minPackSize, maxPackSize);
    }
}
