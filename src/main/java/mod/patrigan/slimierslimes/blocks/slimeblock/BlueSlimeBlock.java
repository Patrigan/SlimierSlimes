...
public class BlueSlimeBlock extends SlimeBlock implements IBlockColor, IItemColor {
    ...
    public int getColor(int tintIndex) {
        return tintIndex == 0 ? DyeColor.BLUE.getColorValue() : -1;
    }
}
