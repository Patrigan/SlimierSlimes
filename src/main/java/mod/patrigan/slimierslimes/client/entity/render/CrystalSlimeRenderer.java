...
public class CrystalSlimeRenderer extends MobRenderer<CrystalSlimeEntity, SlimeModel<CrystalSlimeEntity>> {
    ...
    public CrystalSlimeRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new SlimeModel<>(16), 0.7f);
        this.addLayer(new SlimeGelLayer<>(this));
    }

    @Override
    public void render(CrystalSlimeEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
