...
public class ModBlocks {
    ...
    public static final BuildingBlockHelper PINK_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.PINK, () -> new PinkSlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_PINK).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper BROWN_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.BROWN, () -> new BrownSlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_BROWN).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper LIGHT_GRAY_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.LIGHT_GRAY, () -> new LightGraySlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_LIGHT_GRAY).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper GRAY_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.GRAY, () -> new GraySlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_GRAY).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper BLACK_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.BLACK, () -> new BlackSlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_BLACK).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper WHITE_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.WHITE, () -> new WhiteSlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.SNOW).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper PURPLE_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.PURPLE, () -> new PurpleSlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_PURPLE).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
    public static final BuildingBlockHelper MAGENTA_SLIME_BLOCK = registerSlimeBlockBuildingBlock("slime_block", DyeColor.MAGENTA, () -> new MagentaSlimeBlock(AbstractBlock.Properties.of(Material.CLAY, MaterialColor.COLOR_MAGENTA).friction(0.8F).sound(SoundType.SLIME_BLOCK).noOcclusion()), false, 0.6F, true);
