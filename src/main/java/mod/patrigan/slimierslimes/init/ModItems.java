...
public class ModItems {
    ...
    //DyeColor Items
    public static final Map<DyeColor, RegistryObject<Item>> JELLY = getDyeColorRegistryObjectHashMap(dyeColor -> registerColoredItem(dyeColor, "_jelly"));
    public static final Map<DyeColor, RegistryObject<Item>> SLIME_BALL = getDyeColorRegistryObjectHashMap(dyeColor -> registerColoredItem(dyeColor, "_slime_ball"));
    ...
    private static RegistryObject<Item> registerColoredItem(DyeColor dyeColorin, String itemId){
        String coloredItemId = dyeColorin.getTranslationKey() + itemId;
